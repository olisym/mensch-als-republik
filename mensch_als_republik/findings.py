"""Nukleus-Findings: eigener Enum, kein Claim-Reject (00 §10, D163, D164)."""
...
class Finding:
    """Vermerk mit Subjekt — constitution_hash (00 §10, D163, D164)."""
...
def dedupe_sort(findings: list[Finding] | tuple[Finding, ...]) -> tuple[Finding, ...]:
    """Findings sortiert und dedupliziert (00 §10)."""
